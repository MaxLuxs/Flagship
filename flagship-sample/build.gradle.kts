...
kotlin {
    ...
    sourceSets {
        ...
        // iOS source sets are automatically created by iosX64(), iosArm64(), etc.
        // Configure them after they're created
        configureEach {
            if (name.contains("ios", ignoreCase = true) && name.contains("Main")) {
